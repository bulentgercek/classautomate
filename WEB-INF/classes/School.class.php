...
class School
{
	...
	public function getChangesList($tableName, $tableCode) 
	{
		...
		if ($tableName == 'person') return getFromArray($this->_personChangesList, array('tableCode'=>$tableCode));
		if ($tableName == 'classroom') return getFromArray($this->_classroomChangesList, array('tableCode'=>$tableCode));
	}
